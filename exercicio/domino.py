...
def peca_valida(peca):
    if peca.direita not in [1,2,3,4,5,6]:
        return False    
    if peca.esquerda not in [1,2,3,4,5,6]:
        return False
    else:
        return True
'''
...
def encaixa_de_algum_jeito(peca1,peca2):
    if peca1.esquerda == peca2.esquerda:
        return True
    if peca1.esquerda == peca2.direita:
        return True
    if peca1.direita == peca2.esquerda:
        return True
    if peca1.direita == peca2.direita:
        return True
    else:
        return False
...
def ciclo_valido(jogo):
    ...
    for num in jogo:
        if cont == 0:
            ...
            cont = cont + 1
        if len(jogo) == cont:
            if inicio.esquerda != num.direita:
                return False
    return True
'''
...
def jogador(jogo,peca):
    if jogo[0].esquerda == peca.esquerda:
        return 'atras'
    if jogo[0].esquerda == peca.direita:
        return 'atras'
    if jogo[-1].direita == peca.esquerda:
        return 'frente'
    if jogo[-1].direita == peca.direita:
        return 'frente'
    return False
